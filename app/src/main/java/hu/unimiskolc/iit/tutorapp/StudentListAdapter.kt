...
class StudentListAdapter(private val context: Fragment, private val course: Course, private val students: List<Student>)
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        rowView.setOnClickListener {
            context.findNavController()
                .navigate(
                    R.id.action_courseDataFragment_to_studentDataFragment,
                    bundleOf(
